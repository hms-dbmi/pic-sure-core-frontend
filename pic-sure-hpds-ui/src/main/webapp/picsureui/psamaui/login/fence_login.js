define(['common/session', 'picSure/settings', 'common/searchParser', 'jquery', 'handlebars', 'text!login/fence_login.hbs', 'text!login/not_authorized.hbs', 'psamaui/overrides/login', 'util/notification', 'footer/footer'],
