define(["filter/filterList", "header/header", "footer/footer", "settings", "output/outputPanel", "picSure/resourceMeta", "jquery", "handlebars", "text!common/mainLayout.hbs", "treeview", "common/styles"],
		...
		return function(){
			...
			$.ajax({
				...
				success: function(){
					...
					$('body').append(HBS.compile(layoutTemplate)(settings));
